// ============================================
// Premsons Jewellers — shared behaviour
// ============================================

(function () {
  const root = document.documentElement;
  const THEME_KEY = 'psj-theme';
  ...
  function initChat() {
    ...
    const replies = [
      "Aapko kis collection mein interest hai — Bridal Suite, Everyday Luxury ya Diamonds?",
      "Hamara showroom Railway Road, Station Diary Mohalla, Rohtak par hai. Timing Mon–Sat 10 AM – 8:30 PM, Sunday closed.",
      "Sabhi gold items 100% BIS Hallmarked hain. Hamara 12+One Investment Plan bhi try karein — 13th month par bonus milta hai.",
  ...
  function initTicker() {
    ...
    if (!track) return;
    const base = [
      { label: '22K Gold', value: '₹7,215 / gm', trend: 'up' },
      { label: '24K Gold', value: '₹7,870 / gm', trend: 'up' },
      { label: 'Diamond (Solitaire, per ct approx)', value: '₹45,000+', trend: '' },
      { label: 'Railway Road Showroom', value: 'Mon–Sat · 10 AM – 8:30 PM', trend: '' }
    ];
    function renderSet() {
...
(function () {
  const WISHLIST_KEY = 'psj-wishlist';
  ...
  function renderProductCard(item) {
    ...
    const waText = encodeURIComponent('Hi, I\'m interested in "' + item.name + '" from PSJ Premsons Jewellers. Could you share more details and pricing?');
    return '<div class="product-card">' +
      '<div class="product-media">' +
        ...
        '<a class="product-enquire" href="https://wa.me/918603335000?text=' + waText + '" target="_blank" rel="noopener">' +
  ...
  window.PSJ = window.PSJ || {};
  window.PSJ.renderProductCard = renderProductCard;
  window.PSJ.isWishlisted = isWishlisted;
  window.PSJ.toggleWishlist = toggleWishlist;
